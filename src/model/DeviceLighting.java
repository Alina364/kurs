...
public class DeviceLighting extends Device{

    public DeviceLighting(String deviceName, float deviceKount, float devicePower, float deviceTime, ArrayList<Float> deviceListPower){
